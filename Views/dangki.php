...
<div class="container mid">
    ...
    <form action="index.php?action=dangki&dk=dangki_action" onsubmit="return Ktra()" method="post">
        <div class="form-group position-relative">
            <label for="name" class="title">Họ và tên:</label><span id="errorname" class="text-danger"></span>
            <div class="input-group">
                <input type="text" class="form-control" oninput="User()" id="name" name="txthoten" placeholder="Nhập họ và tên">
                <span class="input-group-text"><i class="fa fa-list"></i></span>
            </div>
        </div>
        <div class="form-group position-relative">
            <label for="address" class="title">Địa chỉ:</label><span id="erroraddress" class="text-danger"></span>
            <div class="input-group">
                <input type="text" class="form-control" oninput="KTraAddress()" id="address" name="txtaddress" placeholder="Nhập địa chỉ">
                <span class="input-group-text"><i class="fa fa-home"></i></span>
            </div>
        </div>
        <div class="form-group position-relative">
            <label for="SDT" class="title">Số điện thoại:</label><span id="errorphone" class="text-danger"></span>
            <div class="input-group">
                <input type="tel" class="form-control" oninput="Phone()" id="SDT" name="txtphone" placeholder="Nhập số điện thoại">
        ...
        <!-- <div class="form-group position-relative">
            ...
            <div class="form-check form-check-inline">
                <input type="radio" class="form-check-input" id="radio" name="radio" value="Nam">
                <label class="form-check-label" for="male">Nam</label>
            </div>
            <div class="form-check form-check-inline">
                <input type="radio" class="form-check-input" id="radio" name="radio" value="Nữ">
                <label class="form-check-label" for="female">Nữ</label>
            </div>
        </div> -->
        <div class="form-group position-relative">
            <label for="email" class="title">Email:</label><span id="memail"  class="text-danger"></span>
            <div class="input-group">
                <input type="email" class="form-control" oninput="KtraEmail()" id="email" name="txtemail" placeholder="Nhập email">
        ...
        <div class="form-group position-relative">
            ...
            <div class="input-group">
                <input type="password" class="form-control" oninput="Password()" name="txtpass" id="password" placeholder="Nhập mật khẩu">
                <span class="input-group-text eye-icon" onclick="ChuyenPassWord('password')"><i class="fa fa-eye"></i></span>
            </div>
        </div>
        <div class="form-group position-relative">
            <label for="confirmPassword" class="title">Nhập lại mật khẩu:</label><span id="errorRpass" class="text-danger"></span>
            <div class="input-group">
                <input type="password" class="form-control" oninput="RePassword()" id="Rpass" placeholder="Nhập lại mật khẩu">
                <span class="input-group-text eye-icon" onclick="ChuyenPassWord('Rpass')"><i class="fa fa-eye"></i></span>
            </div>
        </div>
        <div class="form-group">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="terms" onchange="DangKi()">
                <label class="form-check-label title" for="terms">
                    Tôi đồng ý với chính sách thành viên và các điều khoản
                </label>
            </div>
        </div>
        <button type="submit" class="btn btn-danger btn-block title" name="submit" id="ChuyenButton">Đăng kí</button>
    </form>
</div>
<script>
